...
export const Clientes = () => {
  return (
    <>
      <div className="relative w-full  mt-6 p-5 md:pt-6 md:pb-12 md:mb-4 md:max-w-7xl rounded-lg bg-gradient-to-tr from-slate-200 to-slate-100 ">
        ...
        <a
          ...
          target="_blank"
          className="color-btn w-[120px] m-auto text-white rounded-2xl text-sm px-3 py-2 block my-3 md:w-[180px] text-center md:py-2 md:text-lg md:hover:scale-95 duration-75"
        >
          Más opiniones
        </a>
      </div>
