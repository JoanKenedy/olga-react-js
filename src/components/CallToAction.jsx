...
export const CallToAction = () => {
  return (
    <>
      <section className="call-to-action  z-10 -mb-32 w-full px-5 py-9 mt-14 md:max-w-7xl rounded-md md:pb-24 md:mt-32 md:-mb-0 relative ">
        <div className="container-call-to-action justify-between md:flex md:absolute md:z-10 color-contacto md:left-0 md:-top-0 md:w-full md:h-80  ">
